...
final class GatheringTitleTVCell: UITableViewCell {
    ...
    private let titleLabel: UILabel = {
        let lb = UILabel()
        lb.font = .lp_Font(.regular, size: 20)
    ...
    func configureCell(data: Gathering, currentUser: LetportsUser, masterNickname: String, logoHex: String?) {
